...
public class ImageHelper {
    ...
    public static void setPicFromFile(ImageView imgView, final int targetW, final int targetH, String imgPath) {
        // Get the dimensions of the bitmap
        BitmapFactory.Options bmOptions = new BitmapFactory.Options();
        bmOptions.inJustDecodeBounds = true;
        BitmapFactory.decodeFile(imgPath, bmOptions);
    ...
    public static void setPicFromFile(ImageView imgView, final int targetW, String imgPath) {
        // Get the dimensions of the bitmap
        BitmapFactory.Options bmOptions = new BitmapFactory.Options();
        bmOptions.inJustDecodeBounds = true;
        BitmapFactory.decodeFile(imgPath, bmOptions);
